...
/**************************
         配置IO口
**************************/
#define SET_SPI_CS  (GPIOE->BSRR=0X01)	//把GPIOA port 0升为高电平(PA3=1)
#define CLR_SPI_CS  (GPIOE->BRR=0X01)	  //把GPIOA port 0降为低电平(PA3=0)
#define SET_RC522RST  GPIOE->BSRR=0X02	//把GPIOA port 1升为高电平(PA4=1)
#define CLR_RC522RST  GPIOE->BRR=0X02	  //把GPIOA port 1降为低电平(PA4=0)
