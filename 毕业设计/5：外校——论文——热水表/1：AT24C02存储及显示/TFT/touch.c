...
//提示字符串
u8* const TP_REMIND_MSG_TBL="请按照提示进行触摸屏校准";
...
{								 
	...
	LCD_Clear(WHITE);//清屏 	   
	POINT_COLOR=BLACK;
	Show_Str(40,40,160,100,(u8*)TP_REMIND_MSG_TBL,24,0);//显示提示信息
...
{	
		...
		GPIOB->CRL&=0XFFFFFF0F;	//PB1/2设置
		GPIOB->CRL|=0X00000030;	//PB1推挽输出,PB2上拉输入
		GPIOB->ODR|=3<<1;      	//PB1/2上拉	 
		GPIOF->CRH&=0XFFFF0000;	//PF9/10/11设置
		GPIOF->CRH|=0X00003838;	//PF10上拉输入,PF9/11推挽输出
