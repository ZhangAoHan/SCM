...
/**************************
         配置IO口
**************************/
#define SET_SPI_CS  (GPIOC->BSRR=0X40)	//把GPIOA port 0升为高电平(PA3=1)  C6
#define CLR_SPI_CS  (GPIOC->BRR=0X40)	  //把GPIOA port 0降为低电平(PA3=0)
#define SET_RC522RST  GPIOC->BSRR=0X80	//把GPIOA port 1升为高电平(PA4=1)  C7
#define CLR_RC522RST  GPIOC->BRR=0X80	  //把GPIOA port 1降为低电平(PA4=0)
