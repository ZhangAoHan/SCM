...
void cq_scan(u8 a)         //附加项  猜拳比大小初始化显示
{
	...
	LCD_DrawRectangle(1,246 ,239 ,319);   //画矩形 触摸按键
	POINT_COLOR=BLACK;
	switch(a)
	{
		case 0:	Show_Str(2,247,144,24,"猜拳开启",24,0);	break;
		case 1: Show_Str(2,247,144,24,"猜拳关闭",24,0);	break;
	}
	POINT_COLOR=BLUE;
	LCD_DrawRectangle(20,289 ,94 ,315);   //画矩形 触摸按键
	LCD_DrawRectangle(148,289 ,222 ,315);   //画矩形 触摸按键
	POINT_COLOR=BLACK;
	Show_Str(21,290,72,24,"第一位",24,0);
	Show_Str(149,290,72,24,"第二位",24,0);
}
