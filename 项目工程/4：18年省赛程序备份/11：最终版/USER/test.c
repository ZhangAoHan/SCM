	...
	{	
		...
		while(fj)     //保证一轮检测完成
		{
			if(fj_mode==1)   //检查第一位
			{
				...
				Show_Str(21,290,93,24,"第一位",24,0);
				...
				for(i=0;i<20;i++)
				{
					...
					if(fj_resut1==1||fj_resut1==2||fj_resut1==3)   //检测完成
					{
						...
						Show_Str(21,290,93,24,"一完成",24,0);
					}
					else
					{
						POINT_COLOR=BLACK;     //开始检查  
						Show_Str(21,290,93,24,"一错误",24,0);
					}
				fj_mode=0;						
				}
			if(fj_mode==2)
			{
				...
				for(i=0;i<20;i++)
				{
					...
					if(fj_resut2==1||fj_resut2==2||fj_resut2==3)   //检测完成
					{
						k2=1;  //表示测试完成
						POINT_COLOR=BLACK;     //开始检查  
						Show_Str(149,290,72,24,"二完成",24,0);
					}
					else
					{
						POINT_COLOR=BLACK;     //开始检查  
						Show_Str(149,290,72,24,"二错误",24,0);
					}
					fj_mode=0;
			}
			    if(k1!=0&&k2!=0)   //测试完成
