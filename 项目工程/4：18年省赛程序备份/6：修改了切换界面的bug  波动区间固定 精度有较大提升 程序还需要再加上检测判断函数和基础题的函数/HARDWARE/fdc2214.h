...
//寄存器
#define FDC2214_DATA_CH0             (0x00)   //样本数据寄存器    数据_ CH0  
...
#define FDC2214_ERROR_CONFIG         (0x19)  //状态配置
#define FDC2214_CONFIG               (0x1A)   //单通道配置
#define FDC2214_MUX_CONFIG           (0x1B)   //多通道配置
