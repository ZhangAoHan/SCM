...
{
		if(fre2>sy2&&(fre2-sy2)<(sb2*1.5))   Show_Str(170,30,48,24,"石头",24,0);   //检测到石头

		else if(fre2<sy2&&(sy2-fre2)<(sb2*1.5))   Show_Str(170,30,48,24,"石头",24,0);  //检测到石头

		
		else if(fre2>jy2&&(fre2-jy2)<(jb2*1.5))  Show_Str(170,30,48,24,"剪刀",24,0);   //检测到剪刀

		else if(fre2<jy2&&(jy2-fre2)<(jb2*1.5))  Show_Str(170,30,48,24,"剪刀",24,0);     //检测到剪刀

		else if(fre2>by2&&(fre2-by2)<(bb2*1.5))  Show_Str(170,30,48,24,"  布",24,0);     //检测到布

		else if(fre2<by2&&(by2-fre2)<(bb2*1.5)) Show_Str(170,30,48,24,"  布",24,0);     //检测到布
